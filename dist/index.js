...
exports._t = exports.addSupportedLocale = exports.getSupportedLocales = exports.addTranslation = exports.setLocale = exports.getLocale = void 0;
...
exports.addSupportedLocale = addSupportedLocale;
function _t(message, params) {
    ...
    let output = (_f = (_e = translation[message]) !== null && _e !== void 0 ? _e : message) !== null && _f !== void 0 ? _f : "";
